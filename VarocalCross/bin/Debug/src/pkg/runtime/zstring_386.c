...
#line 3328 "C:\Go\src\pkg\runtime\string.goc"
String runtime·emptystring; 
#line 3330 "C:\Go\src\pkg\runtime\string.goc"
int32 
runtime·findnull ( byte *s ) 
{ 
int32 l; 
#line 3335 "C:\Go\src\pkg\runtime\string.goc"
if ( s == nil ) 
return 0; 
for ( l=0; s[l]!=0; l++ ) 
; 
...
#line 3342 "C:\Go\src\pkg\runtime\string.goc"
int32 
runtime·findnullw ( uint16 *s ) 
{ 
int32 l; 
#line 3347 "C:\Go\src\pkg\runtime\string.goc"
if ( s == nil ) 
return 0; 
for ( l=0; s[l]!=0; l++ ) 
; 
...
#line 3354 "C:\Go\src\pkg\runtime\string.goc"
uint32 runtime·maxstring = 256; 
#line 3356 "C:\Go\src\pkg\runtime\string.goc"
static String 
gostringsize ( int32 l ) 
{ 
String s; 
uint32 ms; 
#line 3362 "C:\Go\src\pkg\runtime\string.goc"
if ( l == 0 ) 
return runtime·emptystring; 
#line 3365 "C:\Go\src\pkg\runtime\string.goc"
...
#line 3376 "C:\Go\src\pkg\runtime\string.goc"
String 
...
#line 3388 "C:\Go\src\pkg\runtime\string.goc"
String 
...
#line 3398 "C:\Go\src\pkg\runtime\string.goc"
Slice 
runtime·gobytes ( byte *p , int32 n ) 
{ 
Slice sl; 
#line 3403 "C:\Go\src\pkg\runtime\string.goc"
...
#line 3410 "C:\Go\src\pkg\runtime\string.goc"
String 
...
#line 3420 "C:\Go\src\pkg\runtime\string.goc"
String 
...
#line 3443 "C:\Go\src\pkg\runtime\string.goc"
String 
...
#line 3459 "C:\Go\src\pkg\runtime\string.goc"
static String 
...
#line 3481 "C:\Go\src\pkg\runtime\string.goc"
#pragma textflag 7 
void
...
#line 3488 "C:\Go\src\pkg\runtime\string.goc"
static int32 
cmpstring ( String s1 , String s2 ) 
{ 
uint32 i , l; 
byte c1 , c2; 
#line 3494 "C:\Go\src\pkg\runtime\string.goc"
l = s1.len; 
if ( s2.len < l ) 
l = s2.len; 
for ( i=0; i<l; i++ ) { 
...
{
#line 3512 "C:\Go\src\pkg\runtime\string.goc"

	v = cmpstring(s1, s2);
	FLUSH(&v);
}

#line 3516 "C:\Go\src\pkg\runtime\string.goc"
int32 
runtime·strcmp ( byte *s1 , byte *s2 ) 
{ 
uint32 i; 
byte c1 , c2; 
#line 3522 "C:\Go\src\pkg\runtime\string.goc"
for ( i=0;; i++ ) { 
c1 = s1[i]; 
c2 = s2[i]; 
if ( c1 < c2 ) 
...
#line 3534 "C:\Go\src\pkg\runtime\string.goc"
byte* 
runtime·strstr ( byte *s1 , byte *s2 ) 
{ 
byte *sp1 , *sp2; 
#line 3539 "C:\Go\src\pkg\runtime\string.goc"
if ( *s2 == 0 ) 
return s1; 
for ( ; *s1; s1++ ) { 
if ( *s1 != *s2 ) 
...
{
#line 3556 "C:\Go\src\pkg\runtime\string.goc"
...
{
#line 3592 "C:\Go\src\pkg\runtime\string.goc"
...
#line 3646 "C:\Go\src\pkg\runtime\string.goc"
enum 
{ 
Runeself = 0x80 , 
} ; 
